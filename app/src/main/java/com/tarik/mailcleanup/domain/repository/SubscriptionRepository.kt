...
interface SubscriptionRepository {
    suspend fun getSubscriptions(account: GoogleSignInAccount, startDate: Calendar, endDate: Calendar): DomainResult<List<Subscription>>
    suspend fun unsubscribeAndClean(account: GoogleSignInAccount, subscription: Subscription, cleanEmails: Boolean): DomainResult<UnsubscribeAction>
